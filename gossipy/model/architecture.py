...
class ResNet34NoRes(TorchModel):
    def __init__(self, num_classes=10):
        super(ResNet34NoRes, self).__init__()
        self.in_planes = 64
        ...
        self.layer1 = self.make_layer(64, 64, 6)
        self.layer2 = self.make_layer(64, 128, 8, stride=2)
        self.layer3 = self.make_layer(128, 256, 12, stride=2)
        self.layer4 = self.make_layer(256, 512, 6, stride=2)
    ...
    def __repr__(self) -> str:
        return "ResNet34NoRes"

def resnet34_no_res(num_classes):
    return ResNet34NoRes(num_classes=num_classes)
