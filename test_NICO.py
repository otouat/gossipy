...
from gossipy.data import AssignmentHandler, ClassificationDataHandler2, NonIIDCustomDataDispatcher, OLDCustomDataDispatcher, OLDCustomDataDispatcher2, get_CIFAR100, get_NICO
...
data_handler = ClassificationDataHandler2(Xtr, ytr, Xte, yte, test_size=config["test_size"])

data_dispatcher = OLDCustomDataDispatcher2(data_handler, n=config["n_nodes"]*config["factors"], eval_on_user=True, auto_assign=True)
