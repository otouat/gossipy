...
scheduler_params = {'milestones': [int(200/wdb.n_local_epochs), int(350/wdb.n_local_epochs), int(450/wdb.n_local_epochs)], 'gamma': 0.1}
...
simulator.start(n_rounds=wdb.epochs, wall_time_limit=1)
