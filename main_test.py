...
from gossipy.simul import MIAGossipSimulator, SimulationReport, MIASimulationReport
...
data_dispatcher = CustomDataDispatcher(data_handler, n=num_nodes*100, eval_on_user=True, auto_assign=True)
