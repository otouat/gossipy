...
from gossipy.data import AssignmentHandler, NonIIDCustomDataDispatcher, OLDCustomDataDispatcher, get_CIFAR100
...
simulator.start(n_rounds=config["epochs"], wall_time_limit=2.5)
